...
from service.database.models import Base, Product, User
from settings.db_config import db_settings
...
# Устанавливает настройки подключения к базе данных, описанные в файле alembic.ini в строке sqlalchemy.url
